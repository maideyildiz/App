...
function RecipeList() {
  ...
  return (
    <ScrollView>
      ...
      <Image source={{uri:"https://img.icons8.com/external-becris-lineal-color-becris/64/000000/external-dish-ketogenic-diet-becris-lineal-color-becris.png"}} alt="recipe" 
      resizeMode='cover'
      style={{
        width:100,
        height:100,
